...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[var(--color-background)] shadow-lg">
      <div className="flex items-center justify-between py-4 px-4 md:px-12">
        ...
        <button
          className="md:hidden text-[var(--color-text-dark)] text-2xl"
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="md:hidden bg-[var(--color-background)] shadow-lg px-4 md:px-12 py-4">
